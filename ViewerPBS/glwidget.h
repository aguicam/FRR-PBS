...
class GLWidget : public QGLWidget {
 ...
 private:
  ...
  /**
   * @brief program_ The prefilter shader program.
   */
  std::unique_ptr<QOpenGLShaderProgram> prefilter_program_;
  /**
   * @brief program_ The brdf-lut shader program.
   */
  std::unique_ptr<QOpenGLShaderProgram> brdf_lut_program_;
  ...
  /**
   * @brief roughness component.
   */
  float roughness_=0.3;
  float metallic_=0.3;

  /**
   * @brief render is the instance that allow us to render objects using VA, VBO or VAO.
   */
  Render render;
 ...
 protected slots:
  ...
  /**
   * @brief SetRoughness Sets the roughness component.
   */
  void SetRoughness(double);
  void SetMetallic(double);
